...
submit_file = "myresult/论文结果/2021DF/eval_CM_scores_file_SSL_LA.txt"
truth_dir = "myresult"
phase = "eval"

asv_key_file = os.path.join(truth_dir, '2021DF_keys/ASV/trial_metadata.txt')
asv_scr_file = os.path.join(truth_dir, '2021DF_keys/ASV/ASVTorch_Kaldi/score.txt')
cm_key_file = os.path.join(truth_dir, '2021DF_keys/CM/trial_metadata.txt')
eer_file = os.path.join(truth_dir, '论文结果/2021DF/eer.txt')



def eval_to_score_fileDF(score_file, cm_key_file):
...
if __name__ == "__main__":
    ...
    _ = eval_to_score_fileDF(submit_file, cm_key_file)
